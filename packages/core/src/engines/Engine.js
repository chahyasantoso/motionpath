...
export class Engine {
  ...
  async loadProject(schema, options = {}) {
    ...
    try { this.#projectRuntime.commitCandidate(staged); }
    catch (error) { this.#projectRuntime.abortCandidate(staged); throw error; }
