...
/** Track is a playhead and local plugin composer; graph state belongs to its owner. */
export class Track {
  ...
  #invalidate(reason) { for (const callback of [...this.#lifecycleSubscribers]) callback({ type: "invalidated", track: this, reason }); }
  ...
  _unmount() { this.#host = null; } get isMounted() { return this.#host !== null; } get childCount() { return this.#children.size; }
