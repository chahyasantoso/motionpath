  ...
  return (
    <div className="app zuma-app">
      <header className="header zuma-header">
        <h1>
          Zuma{" "}
          <span className="spiral-accent">
            {vm.title.split(" ").slice(1).join(" ")}
          </span>
        </h1>
      ...
      <section className="spiral-scene">
        <div className="scene-label">
          <h2>
            Endless Spiral <span className="spiral-accent">· Zuma Flow</span>
          </h2>
          <p>
            Balls auto-spawn from the outer edge and spiral into the black hole.
            Click any ball to pop it — siblings slide smoothly to fill the gap.
          </p>
        </div>
