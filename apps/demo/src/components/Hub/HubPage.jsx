...
const DEMOS = [
  {
    ...
    color: "glow-blue",
    description:
      "A rocket follows a continuous 2D cubic Bezier path. Scrolling down staggers cards along complex Bezier/Helix layouts using native DOM updates and zero React re-renders.",
    features: [
  ...
  },
  {
    ...
    color: "glow-amber",
    description:
      "Smooth timeline looping animation. A motorcycle rides along an S-curve road with dynamic auto-rotation, layered shadows, moving clouds, and speed streaks.",
    features: [
  ...
  },
  {
    ...
    color: "glow-blue",
    description:
      "An endless Zuma-style spiral path. Balls auto-spawn on a parent timeline, travel towards a central black hole, and disappear. Pop balls to trigger exit animations and watch siblings reflow natively.",
    features: [
      "Archimedean spiral path generator",
      "Time-triggered auto spawner",
      "Parent timeline with native stagger reflow",
    ],
  },
  {
    id: "spike-refresh",
    ...
    color: "glow-green",
    description:
      "A technical benchmark validating the engine's limits. Updates hundreds of elements at 60fps on high-frequency scrolling, testing container destruction and recreation.",
    features: [
      "Component mount benchmark",
      "Destroy/recreate lifecycle",
      "Direct ref subscription performance",
    ],
  },
];
    ...
    <div className="hub-container">
      ...
      <section className="hub-specs">
        <div className="spec-card">
          ...
          <p>
            Bypasses React rendering cycles. Proxied animation values stream
            directly to DOM refs via clean pub/sub channels.
          </p>
        </div>
        <div className="spec-card">
        ...
        <div className="spec-card">
          ...
          <p>
            Separates GSAP state from layout styles. Composes custom filters, 3D
            matrices, and CSS variables on any rendering target.
          </p>
        </div>
      </section>
      ...
      <footer className="hub-footer">
        <p>
          © 2026 MotionPath Engine. Crafted with React, GSAP, and Antigravity.
        </p>
      </footer>
    </div>
  );
