...
|---|---|---|---|---|
| Track is a leaf | PRs #128, #129, #132, #133, #134, #135, #136, #137, and #138 establish composition parity, explicit standalone ownership, initial GraphBinding wiring, and Motion child-slot APIs | PR #139 is open; Track still contains compatibility observation methods/state, child topology, and group-host/playback bridges | P2-03/P2-04 | Final Track symbol-ban plus lifecycle suites |
...
| ObservationGraph owns graph state | PR #115 metadata/index ownership; PRs #119-#121/#123/#127/#128/#133/#134/#135/#136/#137/#138 add ObservationState, composition parity, transaction routing, rollback, explicit standalone ownership, factory boundaries, and GraphBinding initial wiring | Track remains the compatibility surface; #139 must pass before the remaining Track state and mutators are removed | P2-03 | No Track observation state, graph/live equivalence, rollback, source removal |
...
- [#139 P2-03 externalize standalone observation ownership from Track](https://github.com/chahyasantoso/motionpath/pull/139): open, latest CI has 6 of 7 checks green, unit tests failing. Do not merge until the full suite is green.
...
No package is complete from documentation alone. The next session must fix #139's unit failure, update this matrix only after the gate is green, and then land the final Track ownership removal with value-level and lifecycle evidence. Keep `publisherRendering`, `crossMotion`, and `freeTracks` disabled by default until their gates say otherwise.
