...
Two items. Both are fix-notes against already-implemented work (Brief 1, Brief 2) — not new briefs. Scope is deliberately kept to the smallest file set per item; do not let either bleed into unrelated files.
